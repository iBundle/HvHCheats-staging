    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Платформа')" class="grid">
                    <flux:navlist.item icon="home" :href="route('dashboard')" :current="request()->routeIs('dashboard')" wire:navigate>{{ __('Дашборд') }}</flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
            ...
            <flux:navlist variant="outline">
                <flux:navlist.item icon="lifebuoy" href="#" target="_blank">
                    {{ __('Служба поддержки') }}
                </flux:navlist.item>
            </flux:navlist>
